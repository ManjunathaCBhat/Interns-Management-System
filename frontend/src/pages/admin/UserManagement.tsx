...
const UserManagement: React.FC = () => {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold">User Management</h1>
            <p className="text-muted-foreground">Manage admins, scrum masters, and interns</p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" onClick={fetchUsers}>
              <RefreshCw className="mr-2 h-4 w-4" />
            ...
            {loading ? (
              ...
              <>
                <table className="w-full">
                  <thead className="border-b bg-muted/30">
                    <tr>
                      <th className="px-4 py-3 text-left w-16 whitespace-nowrap">Sl No</th>
  ...
  <p className="text-sm text-muted-foreground truncate">{user.email}</p>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-background rounded-lg w-full max-w-md p-6 space-y-4 shadow-xl">
            <h2 className="text-lg font-semibold">Add New User</h2>
